# See original script on https://extgit.iaik.tugraz.at/krypto/hadeshash

# The constants for the base field of the curve: JubJub
# GF(p), n = 255, t = 3, alpha=5: 
# sage generate_params_poseidon.sage 1 0 255 3 5 128 0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001

# The constants for the base field of the curve: Pallas
# GF(p), n = 255, t = 3, alpha=5: 
